...
<body>
    ...
    <section class="escola">
        <div class="escola-div-conteudo">
            ...
            <p class="escola-texto-um">A Escola Wannin foi fundada em 2001 e tem como objetivo ensinar Pensamento Computacional, através do ensino de  Programação.</p>
